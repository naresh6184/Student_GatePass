...
class RejectedGatePassesPage extends StatefulWidget {
  const RejectedGatePassesPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _RejectedGatePassesPageState createState() => _RejectedGatePassesPageState();
}

class _RejectedGatePassesPageState extends State<RejectedGatePassesPage> {
  bool isLoading = true;
  ...
  void initState() {
    super.initState();
    fetchRejectedGatePasses();
  }

  Future<void> fetchRejectedGatePasses() async {
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading
          ...
          ? const Center(child: Text("No rejected gate passes found."))
          : ListView.builder(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20), // Add spacing before the reject reason
              _buildInfoRow("Reject Reason", widget.gatePass['RejectReason'] ?? "N/A"),
