...
class EmergencyGatePassPage extends StatefulWidget {
  const EmergencyGatePassPage({super.key});

  @override
  _EmergencyGatePassPageState createState() => _EmergencyGatePassPageState();
}

class _EmergencyGatePassPageState extends State<EmergencyGatePassPage> {
  ...
  Future<void> generateGatePass(
    ...
    String gatepassType = "EMERGENCY"; // Example value, can be dynamic
